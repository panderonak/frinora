...
const Page = () => {
  ...
  return (
    <div className="bg-brand-ghost py-24 sm:py-32">
      <MaxWidthWrapper>
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p className="mt-6 text-base/7 text-gray-600 max-w-prose text-center text-pretty">
            ...
            nihil cumque suscipit tenetur eos esse nemo consequatur aperiam
            possimus eligendi.
          </p>
        </div>
        <div className="bg-white mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
          <div className="p-8 sm:p-10 lg:flex-auto">
            ...
            <p className="mt-6 text-base/7 text-gray-600">
              ...
              voluptatem deleniti reprehenderit nostrum odit cupiditate sed sint
              velit minima.
            </p>
            <div className="mt-10 flex items-center gap-x-4">
              <h4 className="flex-none text-sm font-semibold text-brand-deep leading-6">
                What&apos;s included
              </h4>
            ...
            <ul className="mt-8 grid grid-cols-1 gap-4 text-sm/6 text-gray-600 sm:grid-cols-2 sm:gap-6">
              {INCLUDED_FEATURES.map((feature) => (
                <li key={feature} className="flex gap-3">
                  <CheckIcon className="h-6 w-5 flex-none text-brand-indigo" />
                  {feature}
                </li>
              ))}
            </ul>
          </div>
          <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:max-md lg:flex-shrink-0">
