...
export const EmptyCategoryState = ({
  ...
  const codeSnippet = `await fetch('https://frinora.com/api/events', {
  method: 'POST',
  headers: {
    ...
    >
      ...
      <div className="w-full max-w-3xl bg-white rounded-lg shadow-lg overflow-hidden">
        <div className="bg-gray-800 px-4 py-2 flex justify-between items-center">
          ...
          <span className="text-gray-400 text-sm">{`your-first-${categoryName}-event.js`}</span>
        </div>
      ...
      <div className="mt-8 flex flex-col items-center space-x-2">
        <div className="flex gap-2 items-center">
          <div className="size-2 bg-green-500 rounded-full animate-pulse duration-100" />
