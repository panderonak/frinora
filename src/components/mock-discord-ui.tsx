    ...
    <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
      <div className="hidden sm:flex w-[72px] bg-[#202225] py-3 flex-col items-center">
        ...
        {[...Array(5)].map((_, i) => (
          <div
            key={i}
            className="size-12 bg-discord-background rounded-3xl flex items-center justify-center mb-3 hover:rounded-xl transition-all duration-200 hover:bg-discord-brand cursor-not-allowed"
          >
      ...
      <div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
        ...
        <div className="flex-1 overflow-y-auto pt-4">
          ...
          <div className="px-2 mb-4">
            ...
            <div className="flex items-center px-2 py-1.5 rounded bg-[#393c43] text-white cursor-pointer">
              ...
              />
              <span className="font-medium">Frinora</span>
            </div>
        ...
        <div className="p-2 bg-[#292b2f] flex items-center">
          {/* <div className="size-8 rounded-full bg-brand-indigo mr-2" /> */}

          <div className="size-10 mr-1.5 bg-discord-brand rounded-full flex items-center justify-center">
            <Icons.discord className="size-3/5 text-white" />
          </div>

          <div className="flex-1">
            <p className="text-sm font-medium text-white">You</p>
            <p className="text-xs text-[#b9bbbe] flex items-center">Online</p>
          </div>

          <div className="flex items-center space-x-2">
            <Tooltip>
              <TooltipTrigger className="bg-[rgba(218,62,68,0.2)] p-1.5 rounded-md">
                <MicOff className="size-5 text-[#da3e44] cursor-pointer" />
              </TooltipTrigger>
              <TooltipContent>
            ...
            <Tooltip>
              <TooltipTrigger className="hover:bg-gray-600/30 p-1.5 rounded-md">
                <Headphones className="size-5 text-[#b9bbbe] hover:text-white cursor-pointer" />
              </TooltipTrigger>
              <TooltipContent>
                <p className="font-semibold">Deafen</p>
              </TooltipContent>
            </Tooltip>
            <Tooltip>
              <TooltipTrigger className="hover:bg-gray-600/30 p-1.5 rounded-md">
                <Settings className="size-5 text-[#b9bbbe] hover:text-white cursor-pointer duration-200 hover:rotate-45" />
              </TooltipTrigger>
              <TooltipContent>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#202225]">
          ...
          <div className="flex items-center">
            ...
            <p className="font-semibold text-white">Frinora</p>
          </div>
